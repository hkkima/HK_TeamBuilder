...
(function (global) {
  ...
  const LABELS = { total: "종합", conflict: "갈등분리", positive: "긍정유지", issue_stack: "고이슈격리", issue_balance: "이슈분산",
    disp_diversity: "성향다양성", leader: "리더확보", mbti_balance: "MBTI", competency_coverage: "역량커버", competency_balance: "역량평준(보조)" };
  ...
  function render() {
    ...
    const keys = ["total", "conflict", "positive", "issue_stack", "issue_balance", "disp_diversity", "leader", "mbti_balance", "competency_coverage", "competency_balance"];
